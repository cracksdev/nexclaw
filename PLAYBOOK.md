# NexClaw Local Agent Playbook

This playbook is a practical guide to run NexClaw with a local model (Ollama), work safely, and get strong day-to-day results.
...
If everything is healthy, NexClaw starts directly.
...
Or let NexClaw recommend the best local model for your goal:
