# NexClaw for Non-Technical Users
...
NexClaw lets you use an AI coding assistant with different model providers such as:
...
After you run `nexclaw`, the CLI should start and wait for your prompt.
